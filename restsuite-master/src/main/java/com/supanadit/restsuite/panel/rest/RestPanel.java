...
public class RestPanel extends JPanel {
    ...
    public ImageIcon getIcon(String iconName) {
        com.supanadit.restsuite.logger.LogWriter.out("getIcon", "ImageIcon");
        com.supanadit.restsuite.logger.LogWriter.out("getIcon", "ImageIcon");
        com.supanadit.restsuite.logger.LogWriter.out("getIcon", "getClassLoader");
        com.supanadit.restsuite.logger.LogWriter.out("getIcon", "getClassLoader");
        com.supanadit.restsuite.logger.LogWriter.out("getIcon", "concat");
    ...
    public ImageIcon svgIcon(String iconName) throws IOException, TranscoderException {
        com.supanadit.restsuite.logger.LogWriter.out("svgIcon", "toString");
        com.supanadit.restsuite.logger.LogWriter.out("svgIcon", "convertSVGToPNG");
        com.supanadit.restsuite.logger.LogWriter.out("svgIcon", "getClassLoader");
        com.supanadit.restsuite.logger.LogWriter.out("svgIcon", "getClassLoader");
        com.supanadit.restsuite.logger.LogWriter.out("svgIcon", "concat");
